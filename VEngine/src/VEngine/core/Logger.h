...
namespace vengine
{
	...
	public:
		static void info(const std::string& message, const std::string& filename, int line_number)
		{
			...
			s_all_text_buffer.append(result.c_str());
		}
		...
		[[nodiscard]] static auto& get_all_text_buffer() { return s_all_text_buffer; }
	...
	private:
		inline static ImGuiTextBuffer s_all_text_buffer = ImGuiTextBuffer{};
